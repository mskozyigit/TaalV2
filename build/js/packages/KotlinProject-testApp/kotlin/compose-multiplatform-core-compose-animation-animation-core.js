(function (root, factory) {
...
}(globalThis, function (_, kotlin_kotlin, kotlin_org_jetbrains_compose_runtime_runtime, kotlin_org_jetbrains_compose_ui_ui_unit, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core, kotlin_org_jetbrains_compose_ui_ui_geometry, kotlin_org_jetbrains_compose_collection_internal_collection, kotlin_org_jetbrains_compose_ui_ui) {
  'use strict';
  ...
  var IntCompanionObject_getInstance = kotlin_kotlin.$_$.n4;
  ...
  var mutableIntObjectMapOf = kotlin_org_jetbrains_compose_collection_internal_collection.$_$.h;
  ...
  var Key_getInstance = kotlin_org_jetbrains_compose_ui_ui.$_$.j4;
  ...
  var isFinite = kotlin_kotlin.$_$.ji;
  var isNaN_1 = kotlin_kotlin.$_$.ni;
  var DoubleCompanionObject_getInstance = kotlin_kotlin.$_$.l4;
  var floatFromBits = kotlin_kotlin.$_$.qc;
  var toRawBits = kotlin_kotlin.$_$.aj;
  var Key_getInstance_1 = kotlin_org_jetbrains_compose_ui_ui.$_$.m4;
  ...
  var Companion_getInstance_6 = kotlin_org_jetbrains_compose_ui_ui_unit.$_$.o3;
  ...
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0_0, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0_1, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0_2, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0_3, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0_4, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  initMetadataForClass(sam$androidx_compose_animation_core_Easing$0_5, 'sam$androidx_compose_animation_core_Easing$0', VOID, VOID, [Easing]);
  ...
  initMetadataForLambda(Transition$animateTo$slambda, CoroutineImpl, [CoroutineImpl], [1]);
    ...
    if (inductionVariable < last)
      do {
        ...
        if (!(lowerBoundVector.get_jz2icb_k$(i) <= upperBoundVector.get_jz2icb_k$(i))) {
          // Inline function 'androidx.compose.animation.core.Animatable.updateBounds.<anonymous>' call
          var message = 'Lower bound must be no greater than upper bound on *all* dimensions. The ' + ('provided lower bound: ' + toString(lowerBoundVector) + ' is greater than upper bound ') + (toString(upperBoundVector) + ' on index ' + i);
  ...
  function animateValueAsState(targetValue, typeConverter, animationSpec, visibilityThreshold, label, finishedListener, $composer, $changed, $default) {
    ...
    if (!(($default & 4) === 0)) {
      $composer_0.startReplaceableGroup_ip860b_k$(728506592);
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(728512439);
    sourceInformation($composer_0, 'CC(remember):AnimateAsState.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(728514586);
    sourceInformation($composer_0, 'CC(remember):AnimateAsState.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(728531669);
    sourceInformation($composer_0, 'CC(remember):AnimateAsState.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
      ...
      if (inductionVariable < last)
        do {
          ...
          if (!!isNaN_0(it.get_jz2icb_k$(i))) {
            ...
            var message = 'AnimationVector cannot contain a NaN. ' + toString(it) + '. Animation: ' + this.toString() + ',' + (' playTimeNanos: ' + playTimeNanos.toString());
            throw IllegalStateException_init_$Create$(toString(message));
          }
        }
         while (inductionVariable < last);
  ...
  protoOf(TargetBasedAnimation).toString = function () {
    return 'TargetBasedAnimation: ' + toString_0(this.initialValue_1) + ' -> ' + toString_0(this.targetValue_1) + ',' + ('initial velocity: ' + toString(this.initialVelocityVector_1) + ', duration: ' + get_durationMillis(this).toString() + ' ms,') + ('animationSpec: ' + toString(this.animationSpec_1));
  };
            ...
            if (inductionVariable_0 < bitCount)
              do {
                ...
                if (slot.and_4spn93_k$(new Long(255, 0)).compareTo_9jj042_k$(new Long(128, 0)) < 0) {
                  ...
                  var value = ((tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE()).toPair_d22x5s_k$(converter.get_convertToVector_s594l4_k$());
  ...
  protoOf(FloatTweenSpec).getVelocityFromNanos_d1b1ck_k$ = function (playTimeNanos, initialValue, targetValue, initialVelocity) {
    ...
    var startNum = this.getValueFromNanos_rdghrw_k$(tmp$ret$0.times_nfzjiw_k$(new Long(1000000, 0)), initialValue, targetValue, initialVelocity);
    var endNum = this.getValueFromNanos_rdghrw_k$(clampedPlayTime.times_nfzjiw_k$(new Long(1000000, 0)), initialValue, targetValue, initialVelocity);
  ...
  function onChildAnimationUpdated($this) {
    $this.set_updateChildrenNeeded_svb67y_k$(true);
    if ($this.get_isSeeking_vjb393_k$()) {
      ...
      if (inductionVariable <= last)
        do {
         ...
         while (inductionVariable <= last);
      $this.set_updateChildrenNeeded_svb67y_k$(false);
    }
  }
  ...
  protoOf(TransitionAnimationState).onPlayTimeChanged_q0ejfv_k$ = function (playTimeNanos, durationScale) {
    var tmp;
    if (durationScale > 0.0) {
      // Inline function 'kotlin.Long.div' call
  ...
  protoOf(TransitionAnimationState).updateTargetValue_pami6j_k$ = function (targetValue, animationSpec) {
    if (!equals(_get_targetValue__jjlmb5(this), targetValue) || _get_needsReset__mzz76h(this)) {
      _set_targetValue__aqsk0r_0(this, targetValue);
      _set_animationSpec__7qdru(this, animationSpec);
      updateAnimation$default(this, VOID, !this.get_isFinished_i1rrnm_k$());
      this.set_isFinished_o05ie7_k$(false);
  ...
  function Transition$updateTarget$lambda($tmp0_rcvr, $targetState, $$changed) {
    return function ($composer, $force) {
      $tmp0_rcvr.updateTarget_57mzmq_k$($targetState, $composer, updateChangedFlags($$changed | 1));
      return Unit_getInstance();
    };
  }
  ...
  protoOf(Transition).get_isRunning_okmtn0_k$ = function () {
    return !_get_startTimeNanos__r31kgr(this).equals(new Long(0, -2147483648));
  };
  ...
  protoOf(Transition).set_updateChildrenNeeded_svb67y_k$ = function (_set____db54di) {
    var this_0 = this.updateChildrenNeeded$delegate_1;
    updateChildrenNeeded$factory();
    this_0.set_value_v1vabv_k$(_set____db54di);
    return Unit_getInstance();
  };
  protoOf(Transition).get_updateChildrenNeeded_mcj2m5_k$ = function () {
    // Inline function 'androidx.compose.runtime.getValue' call
    var this_0 = this.updateChildrenNeeded$delegate_1;
  ...
  protoOf(Transition).onFrame_wjwgn9_k$ = function (frameTimeNanos, durationScale) {
    if (_get_startTimeNanos__r31kgr(this).equals(new Long(0, -2147483648))) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        if (!item.get_isFinished_i1rrnm_k$()) {
          item.onPlayTimeChanged_q0ejfv_k$(this.get_playTimeNanos_50m2yz_k$(), durationScale);
        }
        if (!item.get_isFinished_i1rrnm_k$()) {
          allFinished = false;
        }
    ...
    if (inductionVariable_0 <= last_0)
      do {
        ...
        if (!equals(item_0.get_targetState_kri3mx_k$(), item_0.get_currentState_snihnl_k$())) {
          item_0.onFrame_wjwgn9_k$(this.get_playTimeNanos_50m2yz_k$(), durationScale);
        }
        if (!equals(item_0.get_targetState_kri3mx_k$(), item_0.get_currentState_snihnl_k$())) {
          allFinished = false;
        }
  ...
  protoOf(Transition).updateTarget_57mzmq_k$ = function (targetState, $composer, $changed) {
    var $composer_0 = $composer;
  ...
  protoOf(Transition).animateTo_rxzkdc_k$ = function (targetState, $composer, $changed) {
    ...
    if (!(($dirty & 91) === 18) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      if (!this.get_isSeeking_vjb393_k$()) {
        this.updateTarget_57mzmq_k$(targetState, $composer_0, 14 & $dirty | 112 & $dirty);
        if (!equals(targetState, this.get_currentState_snihnl_k$()) || this.get_isRunning_okmtn0_k$() || this.get_updateChildrenNeeded_mcj2m5_k$()) {
          $composer_0.startReplaceableGroup_ip860b_k$(335118070);
  ...
  function updateTransition(targetState, label, $composer, $changed, $default) {
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(-659309451);
    sourceInformation($composer_0, 'CC(remember):Transition.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(-659305371);
    sourceInformation($composer_0, 'CC(remember):Transition.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
  ...
  function createTransitionAnimation(_this__u8e3s4, initialValue, targetValue, animationSpec, typeConverter, label, $composer, $changed) {
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(1396598626);
    sourceInformation($composer_0, 'CC(remember):Transition.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(1396626511);
    sourceInformation($composer_0, 'CC(remember):Transition.kt#9igjgp');
    // Inline function 'androidx.compose.runtime.cache' call
  ...
  function updateChildrenNeeded$factory() {
    return getPropertyCallableRef('updateChildrenNeeded', 1, KMutableProperty1, function (receiver) {
      return receiver.get_updateChildrenNeeded_mcj2m5_k$();
    }, function (receiver, value) {
      return receiver.set_updateChildrenNeeded_svb67y_k$(value);
    });
  }
  ...
  protoOf(VectorizedFloatAnimationSpec).getValueFromNanos_xg3j38_k$ = function (playTimeNanos, initialValue, targetValue, initialVelocity) {
    ...
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        _get_valueVector__r10idf(this).set_ln2e3z_k$(i, this.anims_1.get_c1px32_k$(i).getValueFromNanos_rdghrw_k$(playTimeNanos, initialValue.get_jz2icb_k$(i), targetValue.get_jz2icb_k$(i), initialVelocity.get_jz2icb_k$(i)));
      }
       while (inductionVariable < last);
  ...
  protoOf(VectorizedFloatAnimationSpec).getVelocityFromNanos_wafrjo_k$ = function (playTimeNanos, initialValue, targetValue, initialVelocity) {
    ...
    var inductionVariable = 0;
    var last = _get_velocityVector__dvxlkl_0(this).get_size_au00c9_k$();
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        _get_velocityVector__dvxlkl_0(this).set_ln2e3z_k$(i, this.anims_1.get_c1px32_k$(i).getVelocityFromNanos_d1b1ck_k$(playTimeNanos, initialValue.get_jz2icb_k$(i), targetValue.get_jz2icb_k$(i), initialVelocity.get_jz2icb_k$(i)));
      }
       while (inductionVariable < last);
  ...
  protoOf(VectorizedFloatAnimationSpec).getDurationNanos_c9o343_k$ = function (initialValue, targetValue, initialVelocity) {
    ...
    var tmp0_iterator = until(0, initialValue.get_size_au00c9_k$()).iterator_jk1svi_k$();
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      var a = maxDuration;
      var b = this.anims_1.get_c1px32_k$(element).getDurationNanos_taoclf_k$(initialValue.get_jz2icb_k$(element), targetValue.get_jz2icb_k$(element), initialVelocity.get_jz2icb_k$(element));
  ...
  protoOf(VectorizedKeyframesSpec).getValueFromNanos_xg3j38_k$ = function (playTimeNanos, initialValue, targetValue, initialVelocity) {
    ...
    var inductionVariable = 0;
    var last = startVal.get_size_au00c9_k$();
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        _get_valueVector__r10idf_0(this).set_ln2e3z_k$(i, lerp(startVal.get_jz2icb_k$(i), endVal.get_jz2icb_k$(i), fraction));
      }
       while (inductionVariable < last);
  ...
  protoOf(VectorizedKeyframesSpec).getVelocityFromNanos_wafrjo_k$ = function (playTimeNanos, initialValue, targetValue, initialVelocity) {
    ...
    init_0(this, initialValue);
    var inductionVariable = 0;
    var last = startNum.get_size_au00c9_k$();
    if (inductionVariable < last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        _get_velocityVector__dvxlkl_1(this).set_ln2e3z_k$(i, (startNum.get_jz2icb_k$(i) - endNum.get_jz2icb_k$(i)) * 1000.0);
      }
       while (inductionVariable < last);
  ...
  function createSpringAnimations$1($visibilityThreshold, $dampingRatio, $stiffness) {
    ...
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$0 = new FloatSpringSpec($dampingRatio, $stiffness, $visibilityThreshold.get_jz2icb_k$(item));
